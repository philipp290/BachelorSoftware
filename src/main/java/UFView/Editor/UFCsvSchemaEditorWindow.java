...
import DView.Editor.CsvEditorWindow;
...
public class UFCsvSchemaEditorWindow extends JFrame {
    ...
    public UFCsvSchemaEditorWindow() {
        try {
    ...
    private void initUI() {
        ...
        //-----------------------------BOTTOM-LEFT--------------------
        JLabel deleteLabel = new JLabel("Lösche: ");
        deleteLabel.setBounds(20,270,80,30);
        deleteLabel.setFont(mainFont);
        getContentPane().add(deleteLabel);

        deleteCol.setBounds(100,270,50,30);
        formatTextField(deleteCol);
        getContentPane().add(deleteCol);

        deleteButton.setBounds(20,310, 130,30);
        formatButton(deleteButton);
        getContentPane().add(deleteButton);

        //-----------------------------BOTTOM-CENTER--------------------
        JLabel switchLabel = new JLabel("Tausche: ");
        switchLabel.setBounds(170,270,80,30);
        switchLabel.setFont(mainFont);
        getContentPane().add(switchLabel);

        switchCol1.setBounds(245,270,50,30);
        formatTextField(switchCol1);
        getContentPane().add(switchCol1);

        switchCol2.setBounds(300,270,50,30);
        formatTextField(switchCol2);
        getContentPane().add(switchCol2);

        switchButton.setBounds(170,310,180,30);
        formatButton(switchButton);
        ...
        lineFour.setBounds(159,261,2,90);
        getContentPane().add(lineFour);
